export const phone = [
  ...
  },
  {
    ...
    name: "Nokia 1100",
    description: `Mobile technology advancements really started to pick up the pace in 2003, starting with the release of Nokia’s monumental ‘1100’ model. On the surface it was a fairly basic mobile phone, offering little more than calls, texts, and other standard features such as an alarm clock and Snake II. It also arrived at a time where smartphones with advanced features such as cameras, complex applications and internet access were becoming more popular. So, you’d probably be surprised to find out this was one of the best-selling phones of all time, selling over <span class="glow"><span id="highlight">[?]</span></span> million models worldwide. This was largely down to the fact that the phone was marketed towards developing countries, it was actually Nokia’s cheapest mobile phone when it was first released to market in late 2003.`,
    year: 2003,
    highlight: 250,
    specifications: {},
  },
  ...
  },
  {
    ...
    description: `Often labelled the <span class="glow"><span id="highlight">[?]</span></span>, the Samsung Galaxy S3 also launched in 2012. With more than 20 million units sold in the first 100 days, this was the first Android phone to consistently outperform the iPhone in polls. The phone introduced several new features to the Galaxy S line including eye-tracking capabilities, support for wireless charging and support for 4G networks.`,
    year: 2012,
    highlight: "‘first great Android phone’",
    specifications: {},
  },
  {
    timelineId: "2013-iphone-5c",
    name: "iPhone 5C",
    description: `In September 2013, Apple once again changed the face of the luxury phone market with its attempt at a cheaper version of the iPhone 5, known as the iPhone 5C. Whilst the iPhone 5 launched with prices from $199 to $399 on a two-year contract, the 5C launched at a fairly affordable <span class="glow"><span id="highlight">[?]</span></span>.`,
    year: 2013,
    highlight: "$99",
    specifications: {},
  },
  {
    ...
    name: "iPhone 5S",
    description: `Apple also launched a higher-priced model at the same time as the 5C, known as the <span class="glow"><span id="highlight">[?]</span></span>, this was the first time it had announced two iPhones at the same event, setting the tone for years to come. Apple’s Phil Schiller described the 5S as “the most forward-thinking smartphone in the world, delivering desktop-class architecture in the palm of your hand”. As well as improved software, the model featured something that iPhone users had only seen before in Sci-Fi movies (although this was actually a feature in Motorola phones since 2011), the ability to unlock your phone with your fingerprint. It also featured an improved 64-bit A7 processor and the first use of Apple’s ‘Control Center’ on an iPhone.`,
    year: 2013,
    highlight: "iPhone 5S",
    specifications: {},
  },
